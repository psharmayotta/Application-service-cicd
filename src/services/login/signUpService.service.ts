...
import { SignupModel } from "../../database/repository/login/signUp/signup.model";
import { SignupDto } from "../../database/repository/userManagement/signup.dto";
import { MembersEntity } from "../../entities/membersEntity";
import { BaseServices } from "../baseService.services";


class SignUpService extends BaseServices {
    constructor(entity: any = MembersEntity, protected awsService: AwsService = new AwsService()) {
        super(entity, awsService);
    }

    getModel(): SignupModel {
    ...
    //         try {
    //             const existingMember = await this.service.findByEmail(model.email);
    //             if (existingMember) {
    //                 // Existing user
